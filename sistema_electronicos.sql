...
CREATE TABLE `usuarios` (
  ...
  `paypal_verified` tinyint(1) DEFAULT 0,
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `email`, `password`, `tipo_usuario`, `nit`, `direccion`, `telefono`, `estado`, `fecha_registro`, `paypal_email`, `paypal_verified`, `paypal_verification_date`) VALUES
...
ALTER TABLE `servicios_mantenimiento`
  ...
  ADD KEY `idx_servicios_categoria` (`categoria_servicio`);
...
--
ALTER TABLE `historial_servicios`
  ADD CONSTRAINT `fk_historial_solicitud` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitudes_servicio` (`id_solicitud`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_historial_tecnico` FOREIGN KEY (`id_tecnico`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;
...
--
ALTER TABLE `solicitudes_servicio`
  ADD CONSTRAINT `fk_solicitud_servicio` FOREIGN KEY (`id_servicio`) REFERENCES `servicios_mantenimiento` (`id_servicio`) ON DELETE CASCADE,
